...
[layers-badge]: https://images.microbadger.com/badges/image/prestosql/cdh5-hive.svg
[layers-link]: https://microbadger.com/images/prestosql/cdh5-hive
[version-badge]: https://images.microbadger.com/badges/version/prestosql/cdh5-hive.svg
[dockerhub-link]: https://hub.docker.com/r/prestosql/cdh5-hive
...
```
$ docker run -d --name hadoop-master -h hadoop-master prestosql/cdh5-hive
```
